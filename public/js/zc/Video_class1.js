...
function getVideo1Comments() {
    ...
    if(data!=""){
        for(var i=0;i<data.length;i++){
            document.getElementById("pinglunBorder").innerHTML+=`<div class="Clear">
            <div class="floatL">
...
function jiancedenglu() {
    if(User_id!=null){
        document.getElementById("pinglun_huifu").innerHTML=`<div class="Clear">
