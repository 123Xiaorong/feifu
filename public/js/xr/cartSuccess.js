...
$("#coverLayerButtonOne").mouseover(function () {
    $("#coverLayerButtonOne").css("cursor","pointer");
});

$("#coverLayerButtonTwo").mouseover(function () {
    $("#coverLayerButtonTwo").css("cursor","pointer");
});